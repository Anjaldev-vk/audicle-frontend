        ...
        <div className="min-h-screen bg-brand-bg flex flex-col items-center justify-center p-6">
            <div className="max-w-md w-full bg-brand-surface p-8 rounded-xl border border-brand-border shadow-2xl">
                ...
                <div className="text-center mb-10">
                    <Link to="/" className="flex items-center justify-center gap-2 text-text-main font-bold text-lg no-underline mb-6">
                ...
                {view === 'request' ? (
                    <form onSubmit={handleRequestOTP} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center">
                            <h2 className="text-3xl font-semibold text-text-main tracking-tight">Forgot Password?</h2>
                            <p className="text-text-muted mt-2 text-sm">Enter your email and we'll send you a 6-digit code.</p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-12 pr-4 py-3 bg-brand-highlight border border-brand-border rounded-lg text-text-main placeholder-text-muted/50 focus:ring-1 focus:ring-blue-500/50 outline-none transition-all"
                                    value={email}
                    ...
                    <form onSubmit={handleResetPassword} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                        <div className="text-center">
                            <h2 className="text-2xl font-semibold text-text-main tracking-tight">Verify OTP</h2>
                            <p className="text-text-muted mt-2 text-sm">Sent to <span className="text-blue-400 font-medium">{email}</span></p>
                        </div>

                        <div className="space-y-4">
                            <div className="relative">
                                <label className="block text-[0.68rem] font-bold tracking-[0.12em] uppercase text-text-muted mb-2 ml-1">6-Digit Code</label>
                                <div className="relative">
                                    <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-text-muted/50" size={18} />
                                    <input
                                        type="text"
                                        placeholder="000000"
                                        required
                        ...
                        <button 
                            ...
                            className="w-full text-xs font-bold tracking-widest text-text-muted hover:text-blue-500 transition-colors uppercase"
                        >
            ...
            <div className="mt-8 text-[0.65rem] text-text-muted tracking-widest uppercase flex gap-4">
