  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-6">
        <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center group-hover:bg-blue-600/10 transition-all border border-transparent group-hover:border-blue-500/20">
          <Video className="w-6 h-6 text-gray-500 group-hover:text-blue-400 transition-colors" />
        </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-white/5">
        ...
        <div className="text-[10px] font-bold text-gray-600 group-hover:text-white uppercase tracking-widest flex items-center gap-1 transition-all">
