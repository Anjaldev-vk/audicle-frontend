...
//     // After login, send them to the page they tried to visit, or dashboard
...
//             // 1. Give the token to the axios interceptor (in-memory)
...
//         } catch (error) {
//             const errorMsg = error.response?.data?.error || "Login failed. Check your credentials.";
...
//             <div className="w-full max-w-md p-8 bg-brand-surface rounded-xl border border-brand-border shadow-2xl">
...
//                             required
//                             className="w-full px-4 py-3 bg-[#111] border border-white/5 rounded-lg text-white placeholder-gray-600 focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none transition-all"
//                             value={email}
...
//                             <label className="block text-[0.68rem] font-bold tracking-[0.12em] uppercase text-gray-500">Password</label>
//                             <Link to="/forgot-password" className="text-[0.68rem] font-bold tracking-[0.12em] uppercase text-blue-500 hover:text-blue-400 transition-colors no-underline">
//                                 Forgot password?
//                             </Link>
//                         </div>
//                         <input
...
//                         className="w-full px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold tracking-widest transition-all shadow-lg shadow-blue-600/10 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
//                     >
...
//                             <span className="px-2 bg-brand-surface text-[0.6rem] font-bold tracking-widest text-gray-600 uppercase">or continue with</span>
//                         </div>
//                     </div>

//                     <button
//                         type="button"
//                         className="w-full flex items-center justify-center gap-3 px-5 py-3 bg-white/5 hover:bg-white/10 text-white border border-white/5 rounded-lg text-xs font-bold tracking-widest transition-all"
//                     >
//                         <GoogleIcon />
//                         GOOGLE
//                     </button>
...
//                         <Link to="/register" className="text-blue-500 font-bold hover:text-blue-400 no-underline ml-1">
//                             Create one
//                         </Link>
//                     </p>
//                 </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center md:items-stretch min-h-[400px]">
          ...
          <div className="w-full md:w-7/12 md:pl-2 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 w-full">
              <div>
                <label className="block text-[0.68rem] font-bold tracking-[0.12em] uppercase text-gray-500 mb-2 ml-1">
                  Email Address
                </label>
                <input
                  type='email'
                  ...
                  required
                  className={`w-full px-4 py-3 bg-[#111] border ${getFieldError('email') ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/50' : 'border-white/5 focus:border-blue-500/50 focus:ring-blue-500/50'} rounded-xl text-white placeholder-gray-600 focus:ring-1 outline-none transition-all text-sm`}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder='••••••••'
                  required
                  className="w-full px-4 py-3 bg-[#111] border border-white/5 rounded-xl text-white placeholder-gray-600 focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none transition-all text-sm"
                />
              </div>
