...
export default function MFASetupPage() {
  ...
  const verifySetup = async (e) => {
    ...
    try {
      ...
      navigate('/dashboard/settings') // Redirect to settings or security page
    } catch (error) {
        ...
        {step === 2 && (
          <div className="text-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="text-left bg-white/5 border border-white/5 rounded-2xl p-4 mb-8">
              <p className="text-[0.65rem] font-bold text-gray-500 uppercase tracking-widest mb-1">Backup Code</p>
