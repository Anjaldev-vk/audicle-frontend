      ...
      <div className="animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="bg-brand-surface border border-brand-border rounded-3xl p-8 text-center">
              <div className="relative inline-block mb-6">
                ...
                <button className="absolute bottom-0 right-0 w-8 h-8 bg-[#111] border border-brand-border rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                  </svg>
                </button>
              </div>
              <h3 className="text-white font-bold text-lg mb-1">{user?.first_name} {user?.last_name}</h3>
              <p className="text-gray-500 text-sm mb-6">{user?.email}</p>
              
              <div className="flex flex-col gap-2">
                <div className="px-4 py-2 bg-white/5 rounded-xl text-[0.65rem] font-bold text-gray-400 uppercase tracking-widest border border-brand-border">
                  {user?.organisation ? 'Organisation User' : 'Individual User'}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="bg-brand-surface border border-brand-border rounded-3xl p-8 md:p-10 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 bg-brand-bg border border-brand-border rounded-xl text-white placeholder-gray-600 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 outline-none transition-all text-sm"
                ...
                <div>
                  ...
                  <input
                    type="email"
                    disabled
                    className="w-full px-4 py-3 bg-brand-bg border border-brand-border rounded-xl text-gray-600 cursor-not-allowed text-sm"
                    value={user?.email || ''}
                  />
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 bg-brand-bg border border-brand-border rounded-xl text-white focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 outline-none transition-all text-sm appearance-none"
                    value={form.timezone}
